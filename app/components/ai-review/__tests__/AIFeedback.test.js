...
describe("AIFeedback", () => {
  ...
  describe("Content Handling", () => {
    ...
    it("handles explanations with special characters", () => {
      const specialExplanation = "Great work! 🎉 You got 85% correct. Here's what you missed: H₂O → water molecule.";
    ...
    it("handles explanations with HTML-like content", () => {
      const htmlExplanation = "Your answer mentioned <strong>photosynthesis</strong> but missed the role of chlorophyll.";
  ...
  describe("Accessibility", () => {
    it("provides accessible text content", () => {
      const explanation = "This explanation should be accessible to screen readers.";
  ...
  describe("Content Display", () => {
    it("preserves text formatting", () => {
      const formattedExplanation = "Your answer was good.\n\nHowever, you could improve by:\n- Being more specific\n- Adding examples\n- Checking spelling";
